...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"bower_components/knockout/dist/knockout.js":[function(require,module,exports) {
var define;
...
},{}],"js/default_data/locations.js":[function(require,module,exports) {
'use strict';
...
var locations = exports.locations = [{
  ...
  place: 'Novo Tempo Supermarket',
  lat: 2.828553,
  lng: -60.675561
}, {
  place: 'Claretiano School',
  lat: 2.829214,
  lng: -60.671615
}, {
  place: 'Senac Roraima',
  ...
  place: 'Objetivo School',
  lat: 2.830989,
  lng: -60.678789
}, {
  place: 'Recanto da Peixada: Fish Restaurant',
  lat: 2.828874,
  lng: -60.674624
}, {
  place: 'Tulipa Restaurant',
  lat: 2.828532,
  lng: -60.672225
}];
},{}],"js/models/location.js":[function(require,module,exports) {
"use strict";
...
var Location = function Location(ko, place, lat, lng) {
...
},{}],"js/view_model/view_model.js":[function(require,module,exports) {
'use strict';
...
var _locations = require('../default_data/locations');
...
var ViewModel = function () {
  function ViewModel(ko) {
    ...
    */
    _locations.locations.forEach(function (l) {
      _this.locations.push(new _location2.default(ko, l.place, l.lat, l.lng));
    });
    ...
    */
    this.filteredLocations = ko.computed(function () {
      return _this.locations().filter(function (l) {
        return l.place().toLowerCase().indexOf(_this.locationFilter().toLowerCase()) >= 0;
      });
    }, this);
  }
  ...
  _createClass(ViewModel, [{
    ...
    */
    ...
    value: function selectLocation(location) {
      ...
      try {
        for (var _iterator = this.filteredLocations()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var loc = _step.value;
...
},{"../default_data/locations":"js/default_data/locations.js","../models/location":"js/models/location.js"}],"js/app.js":[function(require,module,exports) {
'use strict';

var _knockout = require('/bower_components/knockout/dist/knockout');

var _knockout2 = _interopRequireDefault(_knockout);

var _view_model = require('./view_model/view_model');

var _view_model2 = _interopRequireDefault(_view_model);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var viewModel = new _view_model2.default(_knockout2.default);
...
init();
},{"/bower_components/knockout/dist/knockout":"bower_components/knockout/dist/knockout.js","./view_model/view_model":"js/view_model/view_model.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/app.eeb828a9.map